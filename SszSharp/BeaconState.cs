...
{
    [SszElement(0, "Vector[Vector[uint8,48], 32]")] public byte[][] Pubkeys { get; set; }
...
public class BeaconState
{
    ...
    [SszElement(5, "Vector[Vector[uint8, 32], 64]")]
    public byte[][] BlockRoots { get; set; }
    [SszElement(6, "Vector[Vector[uint8, 32], 64]")]
    public byte[][] StateRoots { get; set; }
    [SszElement(7, "List[Vector[uint8, 32], 16777216]")]
    public byte[][] HistoricalRoots { get; set; }
    [SszElement(8, "Container")]
    public Eth1Data Eth1Data { get; set; }
    [SszElement(9, "List[Container[SszSharp.Eth1Data], 32]")]
    public List<Eth1Data> Eth1DataVotes { get; set; }
    [SszElement(10, "uint64")]
    public ulong Eth1DepositIndex { get; set; }
    [SszElement(11, "List[Container[SszSharp.ValidatorNodeStruct], 1099511627776]")]
    public List<ValidatorNodeStruct> Validators { get; set; }
    [SszElement(12, "List[uint64, 1099511627776]")]
    public List<ulong> Balances { get; set; }
    [SszElement(13, "Vector[Vector[uint8, 32], 64]")]
    public byte[][] RandaoMixes { get; set; }
    [SszElement(14, "Vector[uint64, 64]")]
    public ulong[] Slashings { get; set; }
    [SszElement(15, "List[uint8, 1099511627776]")]
    public byte[] PreviousEpochParticipation { get; set; }
    [SszElement(16, "List[uint8, 1099511627776]")]
    public byte[] CurrentEpochParticipation { get; set; }
    [SszElement(17, "Bitvector[4]")]
    public bool[] JustificationBits { get; set; }
    [SszElement(18, "Container")]
    public Checkpoint PreviousJustifiedCheckpoint { get; set; }
    [SszElement(19, "Container")]
    public Checkpoint CurrentJustifiedCheckpoint { get; set; }
    [SszElement(20, "Container")]
    public Checkpoint FinalizedCheckpoint { get; set; }
    [SszElement(21, "List[uint64, 1099511627776]")]
    public ulong[] InactivityScores { get; set; }
    [SszElement(22, "Container")]
    public SyncCommittee CurrentSyncCommittee { get; set; }
    [SszElement(23, "Container")]
    public SyncCommittee NextSyncCommittee { get; set; }
    [SszElement(24, "Container")]
    public ExecutionPayloadHeader LastExecutionPayloadHeader { get; set; }
}